...
**1,000+ active users across 867 Discord servers** • Idea to production in 2 months as sole engineer

- 6 FastAPI microservices, Next.js frontend, PostgreSQL, Discord bot integration
- Claude API with prompt caching achieving ~90% cost reduction on inference
- 33 Discord slash commands, RBAC subscription system, full campaign management
- AWS CDK infrastructure with zero-downtime deployments

### AI Job Application Assistant — Chrome Extension

**80% reduction in application time** • Site-specific extraction across major job boards

- Claude via AWS Bedrock for resume and cover letter generation
- DOM extractors for LinkedIn, Indeed, and Glassdoor
- OpenSearch vector search, FastAPI on ECS Fargate, CloudFormation IaC

### Federal Data Pipelines — GovStar

**Multi-agency analytics platforms for CBP, ICE, and FEMA**
